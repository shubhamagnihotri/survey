...
$pdf = new MYPDFSSTATE(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
...
//$pdf->Image('C:\Program Files\xampp\htdocs\nlcpr\writereaddata\nlcprpdf\chart\state_wise_chart.png', 10, 20, 400, 250, '', '', '', true, 72);
//$dir='\Program Files\xampp\htdocs\nlcpr\writereaddata\nlcprpdf\chart/';
//$filename = 'statewise_pdf.pdf';


$pdf->Image('/home/nlcpr/docs/writereaddata/nlcprpdf/chart/state_wise_chart.png', 8, 40, 190, 135, '', '', '', true, 100);
