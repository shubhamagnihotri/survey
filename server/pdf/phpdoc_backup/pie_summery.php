...
//$pdf = new MYPDFSPIE('P', PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);

$pdf = new MYPDFSPIE(PDF_PAGE_ORIENTATION, PDF_UNIT, PDF_PAGE_FORMAT, true, 'UTF-8', false);
...
//$pdf->Image('C:\Program Files\xampp\htdocs\nlcpr\writereaddata\nlcprpdf\chart\piechart.png', 10, 20, 400, 250, '', '', '', true, 72);
//$dir='\Program Files\xampp\htdocs\nlcpr\writereaddata\nlcprpdf\chart/';
//$filename = 'piechartpdf.pdf';




$pdf->Image('/home/nlcpr/docs/writereaddata/nlcprpdf/chart/piechart.png', 10, 40, 190, 145,'', '', '', true, 100);
