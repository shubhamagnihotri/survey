...
foreach($log_state as $row_state){
    ...
    $q->addWhere("project_id=task_project and task_start_date between '$from' and '$today' and task_state='$state_id' and task_nlcpr_project=1");
    ...
    foreach($log_project as $row_project)
    {
        ...
        $q->addWhere("task_project=$proj_id and task_start_date between '$from' and '$today' and task_state='$state_id' and task_nlcpr_project=1");
