...
var Main = function() {
	...
	var runNavigationMenu = function () {
	    ...
	    $('.main-navigation-menu > li a').off('click').on('click', function () {
			if($(this).parent().children('ul').hasClass('sub-menu') && ((!$('body').hasClass('navigation-small') || $windowWidth < 767) || !$(this).parent().parent().hasClass('main-navigation-menu'))) {
				if(!$(this).parent().hasClass('open')) {
				    ...
				    $(this).parent().parent().children('li.open').not($(this).parent()).not($('.main-navigation-menu > li.active')).removeClass('active').removeClass('open').children('ul').slideUp(200);
